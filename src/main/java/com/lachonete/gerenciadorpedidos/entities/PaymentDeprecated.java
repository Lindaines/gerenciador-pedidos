...
public class PaymentDeprecated extends AggregateRoot<PaymentId> {
...
//    }
    ...
    private PaymentDeprecated(Builder builder) {
    ...
    public static final class Builder {
        ...
        public PaymentDeprecated build() {
            return new PaymentDeprecated(this);
        }
    }
}
